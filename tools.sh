...
sudo apt install python3.8 git openssh-server python3-setuptools rdate vim curl nmap libssl-dev libffi-dev python-dev build-essential python3.8-distutils python3.8-venv python3.8-dev -y 
